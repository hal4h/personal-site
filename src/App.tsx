...
function HomeHero() {
  ...
  return (
    <div className="page hero-page" style={{ minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: 0 }}>
      <header style={{ width: '100%', maxWidth: 1200, margin: '0 auto', padding: '2.5rem 2rem 0 2rem', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        <h1 style={{ fontFamily: 'Fira Mono, monospace', fontSize: '2.2rem', fontWeight: 700, color: 'var(--primary-color)', marginBottom: '0.7rem', letterSpacing: '-1px', whiteSpace: 'pre' }}>
          {displayed}
          <span style={{ opacity: showCursor ? 1 : 0, transition: 'opacity 0.2s', color: 'var(--accent-color)' }}>|</span>
        </h1>
        <p style={{ fontFamily: 'Fira Mono, monospace', fontSize: '1.1rem', color: 'var(--text-muted)', marginBottom: '2.2rem', maxWidth: 600 }}>
        ...
        <div style={{ marginBottom: '2.2rem', maxWidth: 600 }}>
          <div style={{
            background: 'rgba(200, 200, 255, 0.13)', // subtle pastel blue overlay
            borderRadius: '10px',
      ...
      <main style={{ width: '100%', maxWidth: 800, margin: '0 auto', padding: '0 2rem' }}>
        <section className="about-details" style={{ marginTop: '0.5rem' }}>
